            ...
            <div class="col-lg-9">
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0 px-lg-5">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <a href="" class="btn btn-primary py-md-3 px-md-5 d-none d-lg-block">Join Our Tribe</a>
                    </div>
                </nav>
            </div>
        </div>
    ...
    <div class="container-fluid p-5">
        ...
        <div class="col-lg-4 col-md-6">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item position-relative">
                    <div class="position-relative overflow-hidden rounded">
                        <a href="http://blog.fitdonewell.com/brad-peterson/"><img class="img-fluid w-100" src="img/brad-team1.jpg" alt=""></a>
                        <div class="team-overlay">
                            <div class="d-flex align-items-center justify-content-start">
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-secondary mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Our Coaches</a>
